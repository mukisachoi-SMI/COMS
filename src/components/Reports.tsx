    ...
    <div className="space-y-6">
      ...
      <div className="card">
        <div className="card-header">
          <h3 className="text-lg font-medium text-gray-900">보고서 종류 선택</h3>
        </div>
      ...
      <div className="card">
        <div className="card-header">
          <h3 className="text-lg font-medium text-gray-900">조건 설정</h3>
        </div>
          ...
          <div className="p-4 bg-gray-50 border-b">
            <div className="grid grid-cols-3 gap-4">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{reportData.count || 0}건</p>
              </div>
              <div>
